...
const VetriOrdini = () => {
    ...
    const fetchScarichi = async () => {
        ...
        try {
            ...
            const response = await fetch(`/api/ordini/vetri/ordinati?riferimento=${searchQuery}&limit=${itemsPerPage}&page=${currentPage}&${new URLSearchParams(filters).toString()}`);
