...
const AggiungiOrdini = () => {
    ...
    const handleRiferimentoChange = (e) => {
        ...
        <div className="under-navbar-pagine" tabIndex={0} onKeyDown={handleKeyDown}>
            ...
            <div className="d-flex flex-column" style={{height: "280px"}}>
                <div className="d-flex flex-column flex-grow-1 justify-content-center border border-black rounded m-2 p-2">
                    <h3>Inserisci ordini</h3>
                    <label htmlFor="data_consegna">Data di consegna</label>
                    <input type="date" name="data_consegna" id="data_consegna" onChange={handleDataChange} value={data_consegna} className={`form-control ${dataError ? "border border-danger" : ""}`} label={dataError} />
                    <label htmlFor="info">Riferimento</label>
                    <textarea type="date" name="info" id="info" onChange={handleRiferimentoChange} value={riferimento} className="form-control" style={{resize: "none"}} placeholder="info"></textarea>
                </div>
