...
const ScarichiProfili = () => {
    ...
    const handleApplyInsert = async () => {
        try {
            const response = await fetch("/api/magazzino/scarichi", {
                method: "POST",
    ...
    const addForm = () => {
        return (
            <div>
                ...
                <label htmlFor="quantita">Quantità (Pz)</label><br/>
                <input 
                    type="number" 
                    step="1"
                    min="1"
    ...
    const fetchScarichi = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `/api/magazzino/scarichi?id_prodotto=${searchQuery}
            ...
            const valoriDaTenere = ["id_prodotto", "id_colore_esterno", "id_colore_interno", "quantita", "lotto", "info"];
    ...
    useEffect(() => {
        ...
        if(queryParams.get("addNew") === "1" && addButtonRef.current) {
            ...
            setNewScarico((prevState) => ({
                ...prevState,
                id_prodotto: queryParams.get("id") || "",
                id_colore_esterno: queryParams.get("ce") || "",
                id_colore_interno: queryParams.get("ci") || "",
                quantita: queryParams.get("qnt") || "",
                lotto: queryParams.get("lt") || "",
                info: queryParams.get("inf") || ""
            }))
        }
...
export default ScarichiProfili;
